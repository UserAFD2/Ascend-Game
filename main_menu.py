...
class MainMenu:
    def __init__(self, game_screen: pygame.Surface, handler) -> None:
        ...
        self.click_sound = pygame.mixer.Sound(r"platform_game\assets\audio\button_click.mp3")
    ...
    def render(self) -> None:
        font = pygame.font.Font(r"platform_game\assets\fonts\Agbalumo\Agbalumo-Regular.ttf", 72)
    ...
    def update(self) -> None:
        ...
        self.handler.game_settings.save_all("platform_game\config\settings_saved.json")
