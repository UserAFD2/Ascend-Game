...
class Door:
    def __init__(self, pos, scale):
        ...
        self.animation_dict = load_animations("platform_game/assets/sprites/mechanical_door", (self.width, self.height))
        self.open = False
...
class Lever:
    def __init__(self, pos, scale):
        ...
        self.animation_dict = load_animations("platform_game/assets/sprites/lever", (self.width, self.height))
        self.on = False
        self.turn_on = False
        self.turn_off = False
...
class LaserDoor:
    def __init__(self, pos, scale):
        ...
        self.animation_dict = load_animations("platform_game/assets/sprites/laser_door", (self.width, self.height))
        self.open = False
