...
class Enemy:
    ...
    def __init__(self,
       ...
       """
        ...
        animation_frames = [pygame.image.load(r"platform_game\assets\bat_enemy\1.png"),
                            pygame.image.load(r"platform_game\assets\bat_enemy\2.png"),
                            pygame.image.load(r"platform_game\assets\bat_enemy\3.png"),
                            pygame.image.load(r"platform_game\assets\bat_enemy\4.png"),
                            pygame.image.load(r"platform_game\assets\bat_enemy\5.png"),]
